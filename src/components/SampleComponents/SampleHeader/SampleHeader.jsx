     ...
     <NavbarBlack/>
        ...
        <div className="row d-flex h-100 px-5 text-center position-relative">
          ...
          <header className="w3-container w3-center w3-padding-32 p-2 text-white" style={{fontFamily:'Raleway'}}>
            <h1 className="mt-4"
         style={{color:'#00FFFF', fontSize:'4rem'}}>SAMPLE<span style={{color:'black', textShadow: "2px 2px 4px #ffffff", fontFamily:'Raleway'}}> COMPONENTS </span> <span style={{  textShadow: "2px 2px 4px rgba(0, 0, 0, 3.5)",

...
export default function Hero() {
  return (
    <div className="container-fluid">
      <div className="row">
        <div className="col-lg-7 col-md-12 bg-body-black  text-white">
          <img src={MeCard} alt="MeCard" className="hero-image img-fluid" />
        </div>
        <div
      ...
      >
        CAROL WARGO{" "}
        <span style={{fontSize:'1rem'}}><p>FULL STACK SOFTWARE DEVELOPER <br></br> UX | UI DESIGNER</p></span>
      </h1>
          <p>
          ...
          {" "}
            at the bottom of each page to ensure nothing is missed! Click

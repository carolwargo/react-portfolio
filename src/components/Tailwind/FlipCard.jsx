...
const FlipCard = () => {
    ...
    return (
        <div className='tw-flex tw-items-center tw-justify-center tw-min-h-screen tw-bg-slate-100'>
            <div className='tw-group tw-h-96 tw-w-96 tw-[perspective:1000px]'>
            <div className='tw-relative tw-w-full tw-h-full tw-rounded-xl tw-shadow-xl tw-transition-all tw-duration-500 tw-[transform-style:preserve-3d] tw-group-hover:[transform:rotateY(180deg)]'>
    ...
    <div className='tw-absolute tw-inset-0 tw-w-full tw-h-full tw-px-12 tw-text-center tw-rounded-xl tw-bg-black/80 tw-text-slate-200 tw-[transform:rotateY(180)] tw-[back visibility:hidden'>

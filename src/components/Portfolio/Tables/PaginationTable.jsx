...
export default function ColumnGroupingTable() {
  ...
  return (
    <Paper sx={{ width: '100%' }} className='shadow border border-black my-4'>
        ...
        overflow content. It also includes pagination for navigating through 
        multiple pages of data.
        </p>
          <hr />
       
      <TableContainer sx={{ maxHeight: 440 }} className='px-2'>
        <Table stickyHeader aria-label="sticky table">
          <TableHead >
            <TableRow>
              ...
              <TableCell align="center" colSpan={3} className='fw-bold'>
                DETAILS
              </TableCell>
            </TableRow>
            <TableRow >
              {columns.map((column) => (
                <TableCell
                className='fw-bold bg-dark-subtle'
                  key={column.id}
                  align={column.align}
